...
/**
 * Servlet implementation class DodavanjeDelaAutora
 */
public class DodavanjeDelaAutoraServlet extends HttpServlet {
...
//		 Delo d= new Delo();
//		 d.setNaslov(naslov);
//		 d.setTehnika(tehnika);
//		 d.setStil(stil);
//		 d.setDatNast(dat);
//		 d.setMestoNast(mesto);
//		 d.setOpis(opis);
//		 d.setId(id);
//		 d.setUri(uri);
//		 d.setAutoriDela(autoriDela);
//		 
//		 
//		 
//		 String autorID=request.getParameter("autorDela");
//
//		  
//		  Poruka poruka = new Poruka();
//		  poruka.setKomanda("DODAJ_DELO_AUTORA");
//		 // poruka.setObjekat1(d);
//		  poruka.setObjekat2(autorID);
//		  
//
...
//	
//	Slika s= new Slika(naslov, tehnika, stil, dat, mesto, opis, uri, id, autoriDela, sirina, visina);
...
//	
//	Skulptura sk= new Skulptura(naslov, tehnika, stil, dat, mesto, opis, uri, id, autoriDela, sirina, visina, duzina);
...
//					opis, uri, id, autoriDela, trajanje, format, audvid);
...
//}
//		 System.out.println("AUTOR ID IZ FORME DELA: "+autorID);
//		 
//		 
//		 
...
//				System.out.println("DOD_DELO_SERVLET:"+ odg.getNaslov());
//				request.setAttribute("delo", odg);
//				
//				in.close();	
//			    out.close();  
//			    sock.close();
//						 
//				 RequestDispatcher disp = request.getRequestDispatcher("/DodatoDelo.jsp");							
				 ...
				 if(tip.equals("audio"))
				 {
					audvid= Vrsta.Audio;
					 ...
					 /*String naslov, String tehnika, String stil,
						...
						String id, HashMap<String, Autor> autoriDela, double trajanje, String format,Vrsta vrsta*/
						MultimedijalniZapis m= new MultimedijalniZapis(naslov, tehnika, stil, dat, mesto, 
								opis, uri, id, autoriDela, 7, format, audvid);
						  poruka.setObjekat1(m);
