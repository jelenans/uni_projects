...
<tr>
			...
			<td>Vrsta:</td> 
			<td><input type = "text" name = "vrsta" value="multimedija" readonly></td>
</tr>
<tr>
...
<tr>
			...
			<td>Trajanje:</td> 
			<td><input type = "text" value="${delo2.trajanje}" name = "trajanje" ></td>
</tr>
<tr>
			
			<td>Format:</td> 
			<td><input type = "text" value="${delo2.format}" name = "format"></td>
</tr>
<tr>
