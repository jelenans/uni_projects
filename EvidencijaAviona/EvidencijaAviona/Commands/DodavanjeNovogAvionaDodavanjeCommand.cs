...
namespace EvidencijaAviona.Commands
{
    ...
    public class DodavanjeNovogAvionaDodavanjeCommand : DodavanjeNovogAvionaAbstractCommand
    {

        public DodavanjeNovogAvionaDodavanjeCommand(IDodavanjeNovogAvionaViewModel vm)
            : base(vm)
        {
