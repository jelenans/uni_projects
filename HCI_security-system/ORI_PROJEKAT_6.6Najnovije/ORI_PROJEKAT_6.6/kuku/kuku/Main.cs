               ...
               if(dr==DialogResult.OK)
               {
                   if (selektovana != null)
                   {
                       foreach (PictureBox p in gradoviPanel1.Controls)
                       {
                           ...
                           {
                               gradoviPanel1.SuspendLayout();
                               int n = Lista.listaRastojanja.Count;
                               for (int k = 0; k < n; k++)
                               {

                                   if (Lista.listaRastojanja[k].g1.Tag.Equals(selektovana.Tag) || Lista.listaRastojanja[k].g2.Tag.Equals(selektovana.Tag))
                                   {
                                       Lista.listaRastojanja.Remove(Lista.listaRastojanja[k]);
                                       n--;
                                       k--;
                                   }
                               }
                   ...
                   foreach (PictureBox p in gradoviPanel1.Controls)
                   {
                       if (p.Tag.Equals(selektovana.Tag))
                       {
                           ...
                           for (int k = 0; k < n; k++)
                           {
                               ...
                               if (Lista.listaRastojanja[k].g1.Tag.Equals(selektovana.Tag) || Lista.listaRastojanja[k].g2.Tag.Equals(selektovana2.Tag))
                               {
                                   Lista.listaRastojanja.Remove(Lista.listaRastojanja[k]);
                                   n--;
                                   k--;
